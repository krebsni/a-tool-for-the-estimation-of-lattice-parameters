...
% d_i are not fixed, => no closed formula for \delta_0 , d_0 has to be varied iteratively and values of d_i have to be stepwise increased until epsilon is reached  to find minimum overall runtime
