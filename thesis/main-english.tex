...
=> python library \textit{Lattice Parameter Estimation}, we will just call \textit{tool} in this work % TODO: too long. Maybe just "tool"?
LWE instances are estimated by calling various estimation functions from the LWE Estimator \cite{APS15}, which we will refer to as \textit{estimator}. % TODO: link in footnote to github repo
