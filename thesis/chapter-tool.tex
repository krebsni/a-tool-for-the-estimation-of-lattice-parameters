...
%     Following \cite{norm-relations}, we apply Hölder's inequality on $n$ dimensional vector spaces. For $\mathbf{x}, \mathbf{y} \in \mathbb{R}^n$ Hölder's inequality states that
%     \begin{align*}
...
\begin{algorithm2e} % TODO: check if block is not of dimension kxk
    ...
    \KwOutput{tuple secure estimate result and parameter set}
...
% TODO: try out and put the results here...