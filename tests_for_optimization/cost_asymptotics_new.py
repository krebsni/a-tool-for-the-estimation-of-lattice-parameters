...
BKZ_COST_ASYMPTOTICS = [
    {
        "name": "Q‑Core‑Sieve",
        "reduction_cost_model": lambda beta, d, B: (0.265*beta),
    ...
    },
    {
        ...
        "reduction_cost_model": lambda beta, d, B: (0.265*beta + 16),
        "success_probability": 0.99,
    ...
    },
    {
        ...
        "reduction_cost_model": lambda beta, d, B: (0.2975*beta),
        "success_probability": 0.99,
    ...
    {
        "name": "Q‑β‑Sieve",
        "reduction_cost_model": lambda beta, d, B: (0.265*beta + log(beta,2)),
        "success_probability": 0.99,
    ...
    {
        "name": "Q‑8d‑Sieve + O(1)",
        "reduction_cost_model": lambda beta, d, B: (0.265*beta + 16.4 + log(8*d,2)),
        "success_probability": 0.99,
    ...
    {
        "name": "Core‑Sieve",
        "reduction_cost_model": lambda beta, d, B: (0.292*beta),
        "success_probability": 0.99,
    ...
    {
        "name": "Core‑Sieve + O(1)",
        "reduction_cost_model": lambda beta, d, B: (0.292*beta + 16),
        "success_probability": 0.99,
    ...
    },
    {
        ...
        "reduction_cost_model": lambda beta, d, B: (0.368*beta),
        "success_probability": 0.99,
    ...
    {
        "name": "β‑Sieve",
        "reduction_cost_model": lambda beta, d, B: (0.292*beta + log(beta,2)),
        "success_probability": 0.99,
    ...
    {
        "name": "8d‑Sieve + O(1)",
        "reduction_cost_model": lambda beta, d, B: (0.292*beta + 16.4 + log(8*d,2)),
        "success_probability": 0.99,
    ...
    },
    {
        ...
        "reduction_cost_model": lambda beta, d, B: ((0.18728*beta*log(beta, 2) - 1.0192*beta + 16.1)/2),
        "success_probability": 0.99,
    ...
    {
        "name": "Lotus",
        "reduction_cost_model": lambda beta, d, B: (-0.7550818937366788*beta + 0.12472525302110621*beta*log(beta,2) + 2.254440896969337),
        "success_probability": 0.99,
    ...
    {
        "name": "Core‑Enum + O(1)",
        "reduction_cost_model": lambda beta, d, B: (0.18728*beta*log(beta, 2) - 1.0192*beta + 16.1),
        "success_probability": 0.99,
    ...
    # {
    #     "name": "8d‑Enum + O(1)",
    #     "reduction_cost_model": lambda beta, d, B: BKZ.LLL(d, B) +  BKZ.svp_repeat(beta, d) * (0.270188776350190*beta*log(beta) - 1.0192050451318417*beta + 16.10253135200765),
    #     "success_probability": 0.99,
    ...
    # },
    {
        ...
        "reduction_cost_model": lambda beta, d, B: log(8*d, 2) + (0.000784314*beta**2 + 0.366078*beta - 6.125 + 7),
        "success_probability": 0.99,
